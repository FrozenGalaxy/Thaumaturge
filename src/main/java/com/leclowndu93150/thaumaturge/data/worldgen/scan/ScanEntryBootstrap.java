...
public final class ScanEntryBootstrap {
    ...
    public static void bootstrap(BootstrapContext<ScanEntry> ctx) {
        ...
        HolderSet<Block> crystals = blocks(blockReg,
        ...
        HolderSet<Block> woods = blocks(blockReg,
        ...
        register(ctx, "ore", "ore",
                blocks(blockReg, concat(
                        List.of(TCBlocks.ORE_AMBER.get(), TCBlocks.ORE_CINNABAR.get()),
                        List.of(TCBlocks.CRYSTAL_AER.get(), TCBlocks.CRYSTAL_IGNIS.get(), TCBlocks.CRYSTAL_AQUA.get(),
                                TCBlocks.CRYSTAL_TERRA.get(), TCBlocks.CRYSTAL_ORDO.get(), TCBlocks.CRYSTAL_PERDITIO.get(),
                                TCBlocks.CRYSTAL_VITIUM.get()))),
                null, null);
        register(ctx, "orecrystal", "scanned/orecrystal", crystals, null, null);
        register(ctx, "plants", "plants",
                blocks(blockReg, concat(
                        List.of(TCBlocks.LOG_GREATWOOD.get(), TCBlocks.LOG_SILVERWOOD.get(),
                                TCBlocks.WOOD_GREATWOOD.get(), TCBlocks.WOOD_SILVERWOOD.get(),
                                TCBlocks.STRIPPED_LOG_GREATWOOD.get(), TCBlocks.STRIPPED_LOG_SILVERWOOD.get(),
                                TCBlocks.STRIPPED_WOOD_GREATWOOD.get(), TCBlocks.STRIPPED_WOOD_SILVERWOOD.get(),
                                TCBlocks.SAPLING_GREATWOOD.get(), TCBlocks.SAPLING_SILVERWOOD.get()),
                        List.of(TCBlocks.PLANT_CINDERPEARL.get(), TCBlocks.PLANT_SHIMMERLEAF.get(),
                                TCBlocks.PLANT_VISHROOM.get()))),
                null, null);
        register(ctx, "plantwood", "scanned/plantwood", woods, null, null);

        register(ctx, "f_teleport", "f_teleport",
        ...
        register(ctx, "f_spider", "f_spider", null, null,
        ...
        register(ctx, "f_fly", "f_fly", null, null,
                entities(entityReg, EntityType.BAT, EntityType.PARROT, EntityType.GHAST, EntityType.BLAZE,
                        TCEntities.TAINT_SWARM.get()));
        register(ctx, "f_dispenser", "f_dispenser", blocks(blockReg, Blocks.DISPENSER), null, null);
        register(ctx, "f_matclay", "f_matclay",
        ...
        register(ctx, "f_matbrass", "f_matbrass",
                blocks(blockReg, TCBlocks.METAL_BRASS_BLOCK.get()),
                items(itemReg, TCItems.INGOT_BRASS.get()),
                null);
        register(ctx, "f_matthaumium", "f_matthaumium",
                blocks(blockReg, TCBlocks.METAL_THAUMIUM_BLOCK.get()),
                items(itemReg, TCItems.INGOT_THAUMIUM.get(), TCItems.PLATE_THAUMIUM.get()),
                null);
        register(ctx, "f_matvoid", "f_matvoid",
                blocks(blockReg, TCBlocks.METAL_VOID_BLOCK.get()),
                items(itemReg, TCItems.INGOT_VOID.get(), TCItems.PLATE_VOID.get()),
                null);
        register(ctx, "f_brain", "f_brain", null,
                items(itemReg, TCItems.BRAIN.get()),
                entities(entityReg, TCEntities.BRAINY_ZOMBIE.get(), TCEntities.GIANT_BRAINY_ZOMBIE.get()));
        register(ctx, "f_golem", "f_golem", null, null,
                entities(entityReg, TCEntities.THAUMATURGE_GOLEM.get(), TCEntities.TURRET_CROSSBOW.get(),
                        TCEntities.TURRET_CROSSBOW_ADVANCED.get(), TCEntities.ARCANE_BORE.get(),
                        EntityType.IRON_GOLEM, EntityType.SNOW_GOLEM, EntityType.SHULKER));
        register(ctx, "f_arrow", "f_arrow", null,
                items(itemReg, Items.ARROW),
                entities(entityReg, EntityType.ARROW, EntityType.SPECTRAL_ARROW, EntityType.TRIDENT,
                        TCEntities.GOLEM_DART.get()));
        register(ctx, "f_fireball", "f_fireball", null, null,
                entities(entityReg, EntityType.FIREBALL, EntityType.SMALL_FIREBALL, EntityType.DRAGON_FIREBALL,
                        EntityType.WITHER_SKULL, EntityType.WIND_CHARGE, EntityType.BREEZE_WIND_CHARGE));
        ...
        register(ctx, "primordial_pearl", "primordial_pearl", null,
                items(itemReg, TCItems.PRIMORDIAL_PEARL.get()), null);
        register(ctx, "f_toomuchflux", "f_toomuchflux", null, null,
                entities(entityReg, TCEntities.FLUX_RIFT.get()));
        register(ctx, "fluxrift", "scanned/fluxrift", null, null,
                entities(entityReg, TCEntities.FLUX_RIFT.get()));
        register(ctx, "orblock1", "scanned/orblock1",
                blocks(blockReg, TCBlocks.STONE_ANCIENT.get(), TCBlocks.STONE_ANCIENT_TILE.get()), null, null);
        register(ctx, "orblock2", "scanned/orblock2",
                blocks(blockReg, TCBlocks.STONE_ELDRITCH_TILE.get()), null, null);
        register(ctx, "outer_revelations", "outer_revelations",
        ...
        register(ctx, "plantcinderpearl", "scanned/plantcinderpearl",
                blocks(blockReg, TCBlocks.PLANT_CINDERPEARL.get()), null, null);
        register(ctx, "plantshimmerleaf", "scanned/plantshimmerleaf",
        ...
        register(ctx, "cultist", "scanned/entity/thaumaturge/cultist", null, null,
                entities(entityReg, TCEntities.CULTIST_KNIGHT.get(), TCEntities.CULTIST_CLERIC.get()));
        register(ctx, "eldritch_crab", "scanned/entity/thaumaturge/eldritch_crab", null, null,
                entities(entityReg, TCEntities.INHABITED_ZOMBIE.get()));
    }

    private static void register(BootstrapContext<ScanEntry> ctx, String name, String key,
                                 @Nullable HolderSet<Block> blocks, @Nullable HolderSet<Item> items,
                                 @Nullable HolderSet<EntityType<?>> entities) {
        ctx.register(ResourceKey.create(ScanEntry.REGISTRY_KEY, TCIds.rl(name)),
                new ScanEntry(TCIds.rl(key),
                        Optional.ofNullable(blocks), Optional.ofNullable(items), Optional.ofNullable(entities)));
    }
