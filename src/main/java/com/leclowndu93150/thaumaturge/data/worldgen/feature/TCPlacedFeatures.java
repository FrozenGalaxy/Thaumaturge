...
public final class TCPlacedFeatures {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        context.register(GREATWOOD_CHECKED, new PlacedFeature(
        ...
        context.register(SILVERWOOD_CHECKED, new PlacedFeature(
        ...
        context.register(BIG_MAGIC_CHECKED, new PlacedFeature(
        ...
        context.register(GREATWOOD_NATURAL, new PlacedFeature(
                configured.getOrThrow(TCConfiguredFeatures.GREATWOOD_TREE),
                List.of(RarityFilter.onAverageOnceEvery(GREATWOOD_RARITY),
                        InSquarePlacement.spread(),
                        PlacementUtils.HEIGHTMAP_OCEAN_FLOOR,
                        PlacementUtils.filteredByBlockSurvival(TCBlocks.SAPLING_GREATWOOD.get()),
                        BiomeFilter.biome())));
        context.register(GREATWOOD_NATURAL_RARE, new PlacedFeature(
                configured.getOrThrow(TCConfiguredFeatures.GREATWOOD_TREE),
                List.of(RarityFilter.onAverageOnceEvery(GREATWOOD_RARE_RARITY),
                        InSquarePlacement.spread(),
                        PlacementUtils.HEIGHTMAP_OCEAN_FLOOR,
                        PlacementUtils.filteredByBlockSurvival(TCBlocks.SAPLING_GREATWOOD.get()),
                        BiomeFilter.biome())));
        context.register(SILVERWOOD_NATURAL, new PlacedFeature(
                configured.getOrThrow(TCConfiguredFeatures.SILVERWOOD_TREE),
                List.of(RarityFilter.onAverageOnceEvery(SILVERWOOD_RARITY),
                        InSquarePlacement.spread(),
                        PlacementUtils.HEIGHTMAP_OCEAN_FLOOR,
        ...
        context.register(ORE_CINNABAR, new PlacedFeature(
                ...
                List.of(CountPlacement.of(ORE_CINNABAR_COUNT),
                        InSquarePlacement.spread(),
                        HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(CINNABAR_MAX_Y)),
                        BiomeFilter.biome())));
        context.register(ORE_QUARTZ, new PlacedFeature(
                configured.getOrThrow(TCConfiguredFeatures.ORE_QUARTZ),
                List.of(CountPlacement.of(ORE_QUARTZ_COUNT),
                        InSquarePlacement.spread(),
                        HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(QUARTZ_MAX_Y)),
                        BiomeFilter.biome())));
        context.register(ORE_AMBER, new PlacedFeature(
                configured.getOrThrow(TCConfiguredFeatures.ORE_AMBER),
                List.of(CountPlacement.of(ORE_AMBER_COUNT),
                        InSquarePlacement.spread(),
        ...
        context.register(CINDERPEARL, new PlacedFeature(
                ...
                List.of(RarityFilter.onAverageOnceEvery(CINDERPEARL_RARITY),
                        InSquarePlacement.spread(),
                        PlacementUtils.HEIGHTMAP,
                        BiomeFilter.biome(),
