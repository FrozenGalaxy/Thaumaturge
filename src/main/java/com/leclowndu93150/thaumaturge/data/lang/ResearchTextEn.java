...
public final class ResearchTextEn {
    ...
    private static void part0(BiConsumer<String, String> add) {
        ...
        add.accept(
                ...
                "Shimmerleaf flowers contain a dormant purifying power much like the Silverwood trees beneath which they grow. By awakening that power I can create an §lEthereal Bloom§r.<BR>The Bloom slowly reclaims land corrupted by Taint within roughly eight blocks. It suppresses new growth and gradually weakens the lingering contamination, but it cannot overpower a strong active Taint Seed. I should destroy the source first.<BR>The Bloom cleans the living corruption of the land. Physical Flux Goo and Gas still require a Flux Scrubber, while numerical Flux remains the domain of aura purification.");
        add.accept(
        ...
        add.accept(
                ...
                "I have developed a rather reckless theory. A primordial pearl and an aura node are both concentrations of raw magical power; forcing them into direct contact should be catastrophic, but the interaction may also alter the node in useful ways.<BR>Anyone foolish enough can attempt this experiment. Completing this research should improve the odds of a favorable result slightly. Very slightly.<BR>The pearl will be consumed, the reaction is violently explosive, and the surrounding area is likely to be contaminated with physical Flux.");
    ...
    private static void part1(BiConsumer<String, String> add) {
        ...
        add.accept(
                ...
                "I have nearly mastered the art of turning concrete objects into liquid essentia, so doing the reverse should be a simple matter.<BR>The essentia crystallizer draws in liquid essentia from a pipe network and slowly converts it into small shards of crystalline essentia. Crystalline essentia is safe to handle and very stable.<BR>The crystallizer either ejects the crystals into the world or places them into a container on its output side. It can be disabled with a redstone signal.<BR>It draws vis from the local aura while processing; a healthy aura greatly increases its speed.");
        add.accept(
                "research.thaumaturge.essentia_crystalizer.stage_1",
                "I can now construct an Essentia Crystallizer. Its tube connection is the input; completed crystals leave from the opposite face.");
        ...
        add.accept(
                "research.thaumaturge.flux_scrubber.stage_1",
                "The scrubber exposes its reclaimed Praecantatio through its single tube face. Reorienting that face does not change its 16-block cleanup radius.");
        ...
        add.accept(
                "research.thaumaturge.essentia_reservoir.stage_1",
                "Like jars, reservoirs can only be accessed from one side, though I can choose how they are oriented. They cannot be emptied or filled by hand, so I need to rely on tubes or golems for that.<BR>Picking up a reservoir while filled is, um, inadvisable.<BR>I was so pleased with this discovery that I showed it off to some of my fellow thaumaturges. Strangely, most of them dived for cover even after I assured them the constant sound of metal under incredible stress is perfectly normal.");
