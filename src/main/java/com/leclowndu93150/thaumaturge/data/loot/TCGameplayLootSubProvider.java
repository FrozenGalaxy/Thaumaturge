...
public final class TCGameplayLootSubProvider implements LootTableSubProvider {
    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> output) {
        ...
        output.accept(TCLootTables.TREASURE_COMMON, LootTable.lootTable().withPool(LootPool.lootPool()
                .setRolls(ConstantValue.exactly(1.0F))
                .add(EmptyLootItem.emptyItem().setWeight(COMMON_EMPTY_WEIGHT))
                .add(entry(TCItems.LOOT_BAG_COMMON, 2))
                .add(entry(TCItems.QUICKSILVER, 2, 1.0F, 3.0F))
                .add(entry(TCItems.AMBER, 2, 1.0F, 3.0F))
                .add(entry(TCItems.NUGGET_QUICKSILVER, 2, 2.0F, 6.0F))
                .add(entry(TCItems.SALIS_MUNDUS, 1, 1.0F, 2.0F))));

        output.accept(TCLootTables.TREASURE_UNCOMMON, LootTable.lootTable().withPool(LootPool.lootPool()
                .setRolls(ConstantValue.exactly(1.0F))
                .add(EmptyLootItem.emptyItem().setWeight(UNCOMMON_EMPTY_WEIGHT))
                .add(entry(TCItems.LOOT_BAG_UNCOMMON, 2))
                .add(entry(TCItems.AMULET_MUNDANE, 1))
                .add(entry(TCItems.RING_MUNDANE, 1))
                .add(entry(TCItems.GIRDLE_MUNDANE, 1))
                .add(entry(TCItems.CURIO_ARCANE, 2))
                .add(entry(TCItems.CURIO_PRESERVED, 1))));

        output.accept(TCLootTables.TREASURE_RARE, LootTable.lootTable().withPool(LootPool.lootPool()
                .setRolls(ConstantValue.exactly(1.0F))
                .add(EmptyLootItem.emptyItem().setWeight(RARE_EMPTY_WEIGHT))
                .add(entry(TCItems.LOOT_BAG_RARE, 3))
                .add(entry(TCItems.THAUMONOMICON, 1))
                .add(entry(TCItems.THAUMIUM_SWORD, 1))
                .add(entry(TCItems.THAUMIUM_PICKAXE, 1))
                .add(entry(TCItems.THAUMIUM_AXE, 1))
                .add(entry(TCItems.THAUMIUM_HOE, 1))
                .add(entry(TCItems.AMULET_FANCY, 1))
                .add(entry(TCItems.RING_FANCY, 1))
        ...
        output.accept(TCLootTables.TREASURE_LIBRARY, LootTable.lootTable().withPool(LootPool.lootPool()
                .setRolls(ConstantValue.exactly(1.0F))
                .add(EmptyLootItem.emptyItem().setWeight(LIBRARY_EMPTY_WEIGHT))
                .add(entry(TCItems.CURIO_KNOWLEDGE, 3, 1.0F, 2.0F))));

        output.accept(TCLootTables.TREASURE_SMITH, LootTable.lootTable().withPool(LootPool.lootPool()
                .setRolls(ConstantValue.exactly(1.0F))
