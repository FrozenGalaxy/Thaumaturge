...
public final class TCGolemParts {
    ...
    public static final DeferredHolder<GolemMaterial, GolemMaterial> CLAY = MATERIALS.register(
            "clay",
            () -> new GolemMaterial(
                    List.of(TCIds.rl("mat_stud_clay")),
    ...
    public static final DeferredHolder<GolemMaterial, GolemMaterial> BRASS = MATERIALS.register(
            "brass",
            () -> new GolemMaterial(
                    List.of(TCIds.rl("mat_stud_brass")),
                    materialTexture("mat_brass"),
                    15638812,
                    16,
                    6,
                    3,
                    stack(TCItems.PLATE_BRASS),
                    stack(TCItems.MECHANISM_SIMPLE),
                    List.of(TCGolemTraits.LIGHT)));
    ...
    public static final DeferredHolder<GolemMaterial, GolemMaterial> THAUMIUM = MATERIALS.register(
            "thaumium",
            () -> new GolemMaterial(
                    List.of(TCIds.rl("mat_stud_thaumium")),
                    materialTexture("mat_thaumium"),
                    5257074,
                    24,
                    10,
                    4,
                    stack(TCItems.PLATE_THAUMIUM),
                    stack(TCItems.MECHANISM_SIMPLE),
                    List.of(TCGolemTraits.HEAVY, TCGolemTraits.FIREPROOF, TCGolemTraits.BLASTPROOF)));
    ...
    public static final DeferredHolder<GolemMaterial, GolemMaterial> VOID = MATERIALS.register(
            "void",
            () -> new GolemMaterial(
                    List.of(TCIds.rl("mat_stud_void")),
                    materialTexture("mat_void"),
                    1445161,
                    20,
                    6,
                    4,
                    stack(TCItems.PLATE_VOID),
                    stack(TCItems.MECHANISM_SIMPLE),
    ...
    public static final DeferredHolder<GolemHead, GolemHead> HEAD_BASIC = HEADS.register(
            "basic",
            () -> new GolemHead(
                    List.of(TCIds.rl("mind_clockwork")),
                    partIcon("head_basic"),
    ...
    public static final DeferredHolder<GolemHead, GolemHead> HEAD_SMART = HEADS.register(
            "smart",
            () -> new GolemHead(
                    List.of(TCIds.rl("mind_biothaumic")),
                    partIcon("head_smart"),
                    new GolemPartModel(
    ...
    public static final DeferredHolder<GolemHead, GolemHead> HEAD_SMART_ARMORED = HEADS.register(
            "smart_armored",
            () -> new GolemHead(
                    List.of(TCIds.rl("mind_biothaumic"), TCIds.rl("golem_combat_adv")),
                    partIcon("head_smartarmor"),
                    new GolemPartModel(obj("golem_head_smart_armor"), null, GolemPartModel.AttachPoint.HEAD),
                    List.of(
                            stackComponent(TCItems.MIND_BIOTHAUMIC), stackComponent(TCItems.PLATE_BRASS),
    ...
    public static final DeferredHolder<GolemHead, GolemHead> HEAD_SCOUT = HEADS.register(
            ...
            () -> new GolemHead(
                    ...
                    null,
                    List.of(TCGolemTraits.SCOUT, TCGolemTraits.FRAGILE)));

    public static final DeferredHolder<GolemHead, GolemHead> HEAD_SMART_SCOUT = HEADS.register(
            "smart_scout",
            () -> new GolemHead(
                    List.of(TCIds.rl("golem_vision"), TCIds.rl("mind_biothaumic")),
                    ...
                    null,
                    List.of(TCGolemTraits.SCOUT, TCGolemTraits.SMART, TCGolemTraits.FRAGILE)));
    ...
    public static final DeferredHolder<GolemArm, GolemArm> ARMS_BREAKERS = ARMS.register(
            "breakers",
            () -> new GolemArm(
                    List.of(TCIds.rl("golem_breaker")),
    ...
    public static final DeferredHolder<GolemLeg, GolemLeg> LEGS_CLIMBER = LEGS.register(
            "climber",
            () -> new GolemLeg(
                    List.of(TCIds.rl("golem_climber")),
                    partIcon("legs_climber"),
                    new GolemPartModel(
                            obj("golem_legs_climber"),
                            TCIds.rl("textures/block/base_metal.png"),
    ...
    public static final DeferredHolder<GolemLeg, GolemLeg> LEGS_FLYER = LEGS.register(
            ...
            () -> new GolemLeg(
                    ...
                    List.of(
                            stackComponent(TCBlocks.LEVITATOR),
