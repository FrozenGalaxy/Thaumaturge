...
public final class TCWandParts {
    ...
    public static final DeferredHolder<WandCap, WandCap> CAP_SILVER = CAPS.register(
            ...
            () -> new WandCap(
                    1.0F,
                    List.of(TCAspects.AER, TCAspects.TERRA, TCAspects.IGNIS, TCAspects.AQUA),
                    0.95F,
                    4,
                    capTexture("silver")));
    ...
    public static final DeferredHolder<WandRod, WandRod> ROD_OBSIDIAN =
            RODS.register("obsidian", () -> wand(75, 6, "obsidian", new WandRodPrimalOnUpdate(TCAspects.TERRA), false));
    public static final DeferredHolder<WandRod, WandRod> ROD_BLAZE =
            RODS.register("blaze", () -> wand(75, 6, "blaze", new WandRodPrimalOnUpdate(TCAspects.IGNIS), true));
    public static final DeferredHolder<WandRod, WandRod> ROD_ICE =
            RODS.register("ice", () -> wand(75, 6, "ice", new WandRodPrimalOnUpdate(TCAspects.AQUA), false));
    public static final DeferredHolder<WandRod, WandRod> ROD_QUARTZ =
            RODS.register("quartz", () -> wand(75, 6, "quartz", new WandRodPrimalOnUpdate(TCAspects.ORDO), false));
    public static final DeferredHolder<WandRod, WandRod> ROD_BONE =
            RODS.register("bone", () -> wand(75, 6, "bone", new WandRodPrimalOnUpdate(TCAspects.PERDITIO), false));
    public static final DeferredHolder<WandRod, WandRod> ROD_REED =
            RODS.register("reed", () -> wand(75, 6, "reed", new WandRodPrimalOnUpdate(TCAspects.AER), false));
    ...
    public static final DeferredHolder<WandRod, WandRod> STAFF_BLAZE = RODS.register(
            "blaze_staff", () -> staff(175, 14, "blaze", new WandRodPrimalOnUpdate(TCAspects.IGNIS), true, false));
    public static final DeferredHolder<WandRod, WandRod> STAFF_ICE = RODS.register(
            "ice_staff", () -> staff(175, 14, "ice", new WandRodPrimalOnUpdate(TCAspects.AQUA), false, false));
    public static final DeferredHolder<WandRod, WandRod> STAFF_QUARTZ = RODS.register(
            "quartz_staff", () -> staff(175, 14, "quartz", new WandRodPrimalOnUpdate(TCAspects.ORDO), false, false));
    public static final DeferredHolder<WandRod, WandRod> STAFF_BONE = RODS.register(
            "bone_staff", () -> staff(175, 14, "bone", new WandRodPrimalOnUpdate(TCAspects.PERDITIO), false, false));
    public static final DeferredHolder<WandRod, WandRod> STAFF_REED = RODS.register(
            "reed_staff", () -> staff(175, 14, "reed", new WandRodPrimalOnUpdate(TCAspects.AER), false, false));
