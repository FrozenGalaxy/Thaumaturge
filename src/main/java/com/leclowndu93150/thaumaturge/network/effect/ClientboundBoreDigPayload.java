...
public record ClientboundBoreDigPayload(BlockPos target, int boreEntityId, int delay)
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, ClientboundBoreDigPayload> STREAM_CODEC =
            StreamCodec.composite(
                    BlockPos.STREAM_CODEC, ClientboundBoreDigPayload::target,
                    ByteBufCodecs.VAR_INT, ClientboundBoreDigPayload::boreEntityId,
                    ByteBufCodecs.VAR_INT, ClientboundBoreDigPayload::delay,
