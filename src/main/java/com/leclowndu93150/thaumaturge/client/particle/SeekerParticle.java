...
public abstract class SeekerParticle extends TCParticle {
    ...
    protected SeekerParticle(ClientLevel level, double x, double y, double z, ParticleSheet sheet,
                             int targetEntityId, Vec3 target, Vec3 spawnVelocity, float driftStrength) {
    ...
    protected SeekerParticle(ClientLevel level, double x, double y, double z, TextureAtlasSprite sprite,
                             int targetEntityId, Vec3 target, Vec3 spawnVelocity, float driftStrength) {
