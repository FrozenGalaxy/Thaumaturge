...
public final class WispyMoteParticle extends TCParticle {
    ...
    private WispyMoteParticle(ClientLevel level, double x, double y, double z,
                              double vx, double vy, double vz, WispyMoteParticleOptions options, ParticleSheet sheet) {
    ...
    public static final class Provider implements ParticleProvider<WispyMoteParticleOptions> {
        ...
        @Override
        public Particle createParticle(WispyMoteParticleOptions options, ClientLevel level, double x, double y, double z,
