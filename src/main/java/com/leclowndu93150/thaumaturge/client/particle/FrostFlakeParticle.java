...
public final class FrostFlakeParticle extends TCParticle {
    ...
    private FrostFlakeParticle(ClientLevel level, double x, double y, double z,
                               double vx, double vy, double vz, FrostFlakeParticleOptions options, ParticleSheet sheet) {
    ...
    public static final class Provider implements ParticleProvider<FrostFlakeParticleOptions> {
        ...
        @Override
        public Particle createParticle(FrostFlakeParticleOptions options, ClientLevel level, double x, double y, double z,
