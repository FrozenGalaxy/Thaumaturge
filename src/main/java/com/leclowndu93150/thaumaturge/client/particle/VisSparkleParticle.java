...
public final class VisSparkleParticle extends TCParticle {
    ...
    private VisSparkleParticle(ClientLevel level, double x, double y, double z,
                               VisSparkleParticleOptions options, ParticleSheet sheet) {
    ...
    public static final class Provider implements ParticleProvider<VisSparkleParticleOptions> {
        ...
        @Override
        public Particle createParticle(VisSparkleParticleOptions options, ClientLevel level, double x, double y, double z,
