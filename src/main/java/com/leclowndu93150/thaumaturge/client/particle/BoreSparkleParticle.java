...
public final class BoreSparkleParticle extends SeekerParticle {
    ...
    private BoreSparkleParticle(ClientLevel level, double x, double y, double z,
                                BoreSparkleParticleOptions options, ParticleSheet sheet) {
        super(level, x, y, z, sheet, options.targetEntityId(),
                new Vec3(options.tx(), options.ty(), options.tz()), Vec3.ZERO, DRIFT);
    ...
    public static final class Provider implements ParticleProvider<BoreSparkleParticleOptions> {
        ...
        @Override
        public Particle createParticle(BoreSparkleParticleOptions options, ClientLevel level, double x, double y, double z,
