...
public final class CrossbowModel extends HierarchicalModel<EntityTurretCrossbow> {
    ...
    public static LayerDefinition createLayer() {
        ...
        PartDefinition crossbow = root.addOrReplaceChild("crossbow",
                CubeListBuilder.create().texOffs(28, 14).mirror()
                        .addBox(-2.0F, 0.0F, -7.0F, 4, 2, 14),
                PartPose.offset(0.0F, 10.0F, 0.0F));
        crossbow.addOrReplaceChild("ammobox",
                CubeListBuilder.create().texOffs(38, 0).mirror()
                        .addBox(-2.0F, -5.0F, -6.0F, 4, 5, 9),
                PartPose.ZERO);
        crossbow.addOrReplaceChild("barrel",
                CubeListBuilder.create().texOffs(20, 28).mirror()
                        .addBox(-1.0F, -1.0F, -8.0F, 2, 2, 2),
                PartPose.ZERO);
        crossbow.addOrReplaceChild("basebarcross",
                CubeListBuilder.create().texOffs(0, 13).mirror()
                        .addBox(-2.0F, 0.5F, 10.0F, 4, 1, 1),
                PartPose.ZERO);
        crossbow.addOrReplaceChild("basebarr",
                CubeListBuilder.create().texOffs(40, 23).mirror()
                        .addBox(-1.0F, 0.0F, 7.0F, 1, 2, 5),
                PartPose.rotation(0.0F, -0.1396263F, 0.0F));
        crossbow.addOrReplaceChild("basebarl",
                CubeListBuilder.create().texOffs(40, 23).mirror()
                        .addBox(0.0F, 0.0F, 7.0F, 1, 2, 5),
                PartPose.rotation(0.0F, 0.1396263F, 0.0F));
        crossbow.addOrReplaceChild("loadbarcross",
                CubeListBuilder.create().texOffs(0, 13).mirror()
                        .addBox(-2.0F, -8.5F, -0.5F, 4, 1, 1),
                PartPose.rotation(LOADBAR_ANGLE, 0.0F, 0.0F));
        crossbow.addOrReplaceChild("loadbarl",
                CubeListBuilder.create().texOffs(0, 15).mirror()
                        .addBox(2.0F, -9.0F, -1.0F, 1, 11, 2),
                PartPose.rotation(LOADBAR_ANGLE, 0.0F, 0.0F));
        crossbow.addOrReplaceChild("loadbarr",
                CubeListBuilder.create().texOffs(0, 15).mirror()
                        .addBox(-3.0F, -9.0F, -1.0F, 1, 11, 2),
                PartPose.rotation(LOADBAR_ANGLE, 0.0F, 0.0F));
        crossbow.addOrReplaceChild("crossl1",
                CubeListBuilder.create().texOffs(0, 0).mirror()
                        .addBox(0.0F, 0.0F, -6.0F, 5, 2, 1),
                PartPose.rotation(0.0F, -CROSS_ANGLE, 0.0F));
        crossbow.addOrReplaceChild("crossl2",
                CubeListBuilder.create().texOffs(0, 0).mirror()
                        .addBox(4.0F, 0.0F, -5.0F, 3, 2, 1),
                PartPose.rotation(0.0F, -CROSS_ANGLE, 0.0F));
        crossbow.addOrReplaceChild("crossl3",
                CubeListBuilder.create().texOffs(0, 0).mirror()
                        .addBox(6.0F, 0.0F, -4.0F, 2, 2, 1),
                PartPose.rotation(0.0F, -CROSS_ANGLE, 0.0F));
        crossbow.addOrReplaceChild("crossr1",
                CubeListBuilder.create().texOffs(0, 0).mirror()
                        .addBox(-5.0F, 0.0F, -6.0F, 5, 2, 1),
                PartPose.rotation(0.0F, CROSS_ANGLE, 0.0F));
        crossbow.addOrReplaceChild("crossr2",
                CubeListBuilder.create().texOffs(0, 0).mirror()
                        .addBox(-7.0F, 0.0F, -5.0F, 3, 2, 1),
                PartPose.rotation(0.0F, CROSS_ANGLE, 0.0F));
        crossbow.addOrReplaceChild("crossr3",
                CubeListBuilder.create().texOffs(0, 0).mirror()
                        .addBox(-8.0F, 0.0F, -4.0F, 2, 2, 1),
                PartPose.rotation(0.0F, CROSS_ANGLE, 0.0F));
        addTripod(root);
