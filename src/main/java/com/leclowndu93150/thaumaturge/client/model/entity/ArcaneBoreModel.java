...
public final class ArcaneBoreModel extends HierarchicalModel<EntityArcaneBore> {
    ...
    public static LayerDefinition createLayer() {
        ...
        base.addOrReplaceChild("crystal",
                CubeListBuilder.create().texOffs(32, 25)
                        .addBox(-1.0F, -4.0F, 5.0F, 2, 2, 2),
                PartPose.ZERO);
        base.addOrReplaceChild("domebase",
                CubeListBuilder.create().texOffs(32, 19)
                        .addBox(-2.0F, -5.0F, 3.0F, 4, 4, 1),
                PartPose.ZERO);
        base.addOrReplaceChild("dome",
                CubeListBuilder.create().texOffs(44, 16)
                        .addBox(-2.0F, -5.0F, 4.0F, 4, 4, 4),
                PartPose.ZERO);
        base.addOrReplaceChild("magbase",
                CubeListBuilder.create().texOffs(0, 18).mirror()
                        .addBox(-1.0F, -4.0F, -6.0F, 2, 2, 3),
                PartPose.ZERO);
        base.addOrReplaceChild("tip",
