...
public final class FortressArmorModel extends AbstractTCArmorModel {
    ...
    public static LayerDefinition createHead() {
        ...
        head.addOrReplaceChild(
                "goggles",
                CubeListBuilder.create().texOffs(100, 18).addBox(-4.5F, -5.0F, -4.25F, 9, 5, 1),
                PartPose.ZERO);
        head.addOrReplaceChild(
                "ornament_l",
        ...
        head.addOrReplaceChild(
                ...
                PartPose.rotation(ORNAMENT_ROT, 0.0F, 0.0F));
        head.addOrReplaceChild(
                "helmet", CubeListBuilder.create().texOffs(41, 8).addBox(-4.5F, -9.0F, -4.5F, 9, 4, 9), PartPose.ZERO);
        head.addOrReplaceChild(
                "helmet_r",
        ...
        head.addOrReplaceChild(
                "capsthingy",
                CubeListBuilder.create().texOffs(21, 0).addBox(-4.5F, -6.0F, -6.5F, 9, 1, 2),
                PartPose.ZERO);
        head.addOrReplaceChild(
                "flap_r",
    ...
    public static LayerDefinition createChest() {
        ...
        body.addOrReplaceChild(
                "belt_r", CubeListBuilder.create().texOffs(76, 44).addBox(-5.0F, 4.0F, -3.0F, 1, 3, 6), PartPose.ZERO);
        body.addOrReplaceChild(
        ...
        body.addOrReplaceChild(
                "belt_l", CubeListBuilder.create().texOffs(76, 44).addBox(4.0F, 4.0F, -3.0F, 1, 3, 6), PartPose.ZERO);
        body.addOrReplaceChild(
                "chestplate",
