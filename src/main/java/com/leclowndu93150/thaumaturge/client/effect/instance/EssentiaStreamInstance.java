...
public final class EssentiaStreamInstance extends StreamInstance {
    ...
    public EssentiaStreamInstance(Vec3 start, List<Vec3> route, @Nullable Vec3 launchDirection,
                                  int fixedTail, int color, int count, float scale, int extend, double my) {
    ...
    protected void onDissolve(ClientLevel level) {
        ...
        ClientEffects.essentiaDrop(level,
