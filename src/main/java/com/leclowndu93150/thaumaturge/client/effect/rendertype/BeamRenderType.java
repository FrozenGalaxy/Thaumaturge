...
public final class BeamRenderType {
    public static final ResourceLocation BEAM =
            ResourceLocation.fromNamespaceAndPath(TCIds.MODID, "textures/effect/beam1.png");
    public static final ResourceLocation BEAML =
            ResourceLocation.fromNamespaceAndPath(TCIds.MODID, "textures/effect/beaml.png");
    ...
    public static final ResourceLocation NODE =
            ResourceLocation.fromNamespaceAndPath(TCIds.MODID, "textures/effect/auranodes.png");
