...
public record BiomeAuraModifier(float value) {
     ...
     */
    public static final Codec<BiomeAuraModifier> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            Codec.FLOAT.fieldOf("value").forGetter(BiomeAuraModifier::value)
