...
public final class BlockEffectSap extends Block {
    ...
    protected void entityInside(BlockState state, Level level, BlockPos pos, Entity entity) {
        ...
        living.addEffect(new MobEffectInstance(
                MobEffects.MOVEMENT_SLOWDOWN, EFFECT_DURATION_TICKS, SLOWNESS_AMPLIFIER, true, true));
    ...
    private static void spawnSpark(
        ...
        level.addParticle(
                new SparkParticleOptions(ARGB32.colorFromFloat(1.0F, r, g, b), alpha, size), x, y, z, 0.0, 0.0, 0.0);
    }
}
