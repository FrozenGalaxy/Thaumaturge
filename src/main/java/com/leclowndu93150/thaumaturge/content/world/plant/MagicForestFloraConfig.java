...
public record MagicForestFloraConfig(
    ...
    public static final Codec<MagicForestFloraConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            BuiltInRegistries.BLOCK.byNameCodec().fieldOf("ambient_grass").forGetter(MagicForestFloraConfig::ambientGrass),
            ...
            Codec.intRange(0, 64).fieldOf("vishroom_attempts").forGetter(MagicForestFloraConfig::vishroomAttempts)
