...
public final class ResearchNotes {
    ...
    public static boolean hasNoteFor(Player player, ResourceLocation learnKey) {
    ...
    public static boolean obtainNote(ServerPlayer player, ResourceLocation entryId, int ordinal) {
        ...
        player.level().playSound(null, player, TCSounds.WRITE.get(), SoundSource.PLAYERS, 0.5F, 1.0F);
        return true;
    }
    ...
    public static Component entryName(HolderLookup.Provider registries, ResourceLocation entryId) {
        return registries
                .lookupOrThrow(IResearchEntry.REGISTRY_KEY)
