...
public final class WarpData implements IPlayerWarp {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, WarpData> STREAM_CODEC = StreamCodec.composite(
            ByteBufCodecs.VAR_INT, d -> d.get(WarpType.PERMANENT),
            ByteBufCodecs.VAR_INT, d -> d.get(WarpType.NORMAL),
            ByteBufCodecs.VAR_INT, d -> d.get(WarpType.TEMPORARY),
            ByteBufCodecs.VAR_INT, WarpData::getCounter,
            WarpData::of
    );
