...
public record EarthPebbleParticleOptions(float scale) implements ParticleOptions {
    ...
    public static final MapCodec<EarthPebbleParticleOptions> CODEC =
            Codec.FLOAT.xmap(EarthPebbleParticleOptions::new, EarthPebbleParticleOptions::scale).fieldOf("scale");
