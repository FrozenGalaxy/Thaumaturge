...
public record FluxSwirlParticleOptions(int color, float scale, float endScale) implements ParticleOptions {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, FluxSwirlParticleOptions> STREAM_CODEC = StreamCodec.composite(
            ByteBufCodecs.INT, FluxSwirlParticleOptions::color,
            ByteBufCodecs.FLOAT, FluxSwirlParticleOptions::scale,
            ByteBufCodecs.FLOAT, FluxSwirlParticleOptions::endScale,
