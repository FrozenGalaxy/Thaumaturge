...
import com.leclowndu93150.thaumcraft.api.golems.parts.GolemAddon;
import com.leclowndu93150.thaumcraft.api.golems.parts.GolemArm;
import com.leclowndu93150.thaumcraft.api.golems.parts.GolemComponent;
...
import com.leclowndu93150.thaumcraft.content.golem.parts.GolemArmDart;
import com.leclowndu93150.thaumcraft.content.golem.parts.GolemLegLevitator;
import com.leclowndu93150.thaumcraft.content.golem.parts.GolemLegWheels;
...
public final class TCGolemParts {
    public static final DeferredRegister<GolemMaterial> MATERIALS =
            DeferredRegister.create(GolemMaterial.REGISTRY_KEY, TCIds.MODID);
    public static final DeferredRegister<GolemHead> HEADS =
            DeferredRegister.create(GolemHead.REGISTRY_KEY, TCIds.MODID);
    public static final DeferredRegister<GolemArm> ARMS =
            DeferredRegister.create(GolemArm.REGISTRY_KEY, TCIds.MODID);
    public static final DeferredRegister<GolemLeg> LEGS =
            DeferredRegister.create(GolemLeg.REGISTRY_KEY, TCIds.MODID);
    public static final DeferredRegister<GolemAddon> ADDONS =
            DeferredRegister.create(GolemAddon.REGISTRY_KEY, TCIds.MODID);
    ...
    public static final DeferredHolder<GolemMaterial, GolemMaterial> WOOD = MATERIALS.register("wood",
            () -> new GolemMaterial(List.of(), materialTexture("mat_wood"), 5059370, 6, 2, 1,
    ...
    public static final DeferredHolder<GolemMaterial, GolemMaterial> IRON = MATERIALS.register("iron",
            () -> new GolemMaterial(List.of(), materialTexture("mat_iron"), 16777215, 20, 8, 3,
    ...
    public static final DeferredHolder<GolemMaterial, GolemMaterial> CLAY = MATERIALS.register("clay",
            () -> new GolemMaterial(List.of(), materialTexture("mat_clay"), 13071447, 10, 4, 2,
    ...
    public static final DeferredHolder<GolemMaterial, GolemMaterial> BRASS = MATERIALS.register("brass",
            () -> new GolemMaterial(List.of(), materialTexture("mat_brass"), 15638812, 16, 6, 3,
    ...
    public static final DeferredHolder<GolemMaterial, GolemMaterial> THAUMIUM = MATERIALS.register("thaumium",
            () -> new GolemMaterial(List.of(), materialTexture("mat_thaumium"), 5257074, 24, 10, 4,
    ...
    public static final DeferredHolder<GolemMaterial, GolemMaterial> VOID = MATERIALS.register("void",
            () -> new GolemMaterial(List.of(), materialTexture("mat_void"), 1445161, 20, 6, 4,
    ...
    public static final DeferredHolder<GolemHead, GolemHead> HEAD_BASIC = HEADS.register("basic",
            () -> new GolemHead(List.of(), partIcon("head_basic"),
                    new GolemPartModel(obj("golem_head_basic"), null, GolemPartModel.AttachPoint.HEAD),
                    List.of(stackComponent(TCItems.MIND_CLOCKWORK)),
                    null, List.of()));

    public static final DeferredHolder<GolemHead, GolemHead> HEAD_SMART = HEADS.register("smart",
            () -> new GolemHead(List.of(), partIcon("head_smart"),
    ...
    public static final DeferredHolder<GolemHead, GolemHead> HEAD_SMART_ARMORED = HEADS.register("smart_armored",
            () -> new GolemHead(List.of(), partIcon("head_smartarmor"),
    ...
    public static final DeferredHolder<GolemHead, GolemHead> HEAD_SCOUT = HEADS.register("scout",
            () -> new GolemHead(List.of(), partIcon("head_scout"),
    ...
    public static final DeferredHolder<GolemHead, GolemHead> HEAD_SMART_SCOUT = HEADS.register("smart_scout",
            () -> new GolemHead(List.of(), partIcon("head_smartscout"),
    ...
    public static final DeferredHolder<GolemArm, GolemArm> ARMS_BASIC = ARMS.register("basic",
            () -> new GolemArm(List.of(), partIcon("arms_basic"),
                    new GolemPartModel(obj("golem_arms_basic"), null, GolemPartModel.AttachPoint.ARMS),
                    List.of(),
                    null, List.of()));

    public static final DeferredHolder<GolemArm, GolemArm> ARMS_FINE = ARMS.register("fine",
            () -> new GolemArm(List.of(), partIcon("arms_fine"),
    ...
    public static final DeferredHolder<GolemArm, GolemArm> ARMS_CLAWS = ARMS.register("claws",
            () -> new GolemArm(List.of(), partIcon("arms_claws"),
    ...
    public static final DeferredHolder<GolemArm, GolemArm> ARMS_BREAKERS = ARMS.register("breakers",
            () -> new GolemArm(List.of(), partIcon("arms_breakers"),
    ...
    public static final DeferredHolder<GolemArm, GolemArm> ARMS_DARTS = ARMS.register("darts",
            () -> new GolemArm(List.of(), partIcon("arms_darts"),
                    new GolemPartModel(obj("golem_arms_darter"), golemTexture("golem_arms_darter"), GolemPartModel.AttachPoint.ARMS),
                    List.of(stackComponent(TCItems.MODULE_AGGRESSION),
    ...
    public static final DeferredHolder<GolemLeg, GolemLeg> LEGS_WALKER = LEGS.register("walker",
            () -> new GolemLeg(List.of(), partIcon("legs_walker"),
                    new GolemPartModel(obj("golem_legs_walker"), null, GolemPartModel.AttachPoint.LEGS),
    ...
    public static final DeferredHolder<GolemLeg, GolemLeg> LEGS_ROLLER = LEGS.register("roller",
            () -> new GolemLeg(List.of(), partIcon("legs_roller"),
    ...
    public static final DeferredHolder<GolemLeg, GolemLeg> LEGS_CLIMBER = LEGS.register("climber",
            () -> new GolemLeg(List.of(), partIcon("legs_climber"),
    ...
    public static final DeferredHolder<GolemLeg, GolemLeg> LEGS_FLYER = LEGS.register("flyer",
            () -> new GolemLeg(List.of(), partIcon("legs_flyer"),
                    new GolemPartModel(obj("golem_legs_floater"), golemTexture("golem_legs_floater"), GolemPartModel.AttachPoint.BODY),
                    List.of(stackComponent(TCBlocks.LEVITATOR),
    ...
    public static final DeferredHolder<GolemAddon, GolemAddon> ADDON_NONE = ADDONS.register("none",
            () -> new GolemAddon(List.of(), TCIds.rl("textures/block/base_metal.png"),
                    null,
                    List.of(),
                    null, List.of()));

    public static final DeferredHolder<GolemAddon, GolemAddon> ADDON_ARMORED = ADDONS.register("armored",
            () -> new GolemAddon(List.of(), partIcon("addon_armored"),
    ...
    public static final DeferredHolder<GolemAddon, GolemAddon> ADDON_FIGHTER = ADDONS.register("fighter",
            () -> new GolemAddon(List.of(), partIcon("addon_fighter"),
                    null,
    ...
    public static final DeferredHolder<GolemAddon, GolemAddon> ADDON_HAULER = ADDONS.register("hauler",
            () -> new GolemAddon(List.of(), partIcon("addon_hauler"),
