...
public final class TCBlockEntities {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityBanner>> BANNER =
            BLOCK_ENTITIES.register(
                    "banner",
                    () -> new BlockEntityType<>(BlockEntityBanner::new, bannerBlocks(), null)
            );
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityResearchTable>> RESEARCH_TABLE =
            BLOCK_ENTITIES.register(
                    "research_table",
                    () -> new BlockEntityType<>(BlockEntityResearchTable::new, Set.of(TCBlocks.RESEARCH_TABLE.get()), null)
            );
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityDeconstructionTable>> DECONSTRUCTION_TABLE =
            BLOCK_ENTITIES.register(
                    ...
                    () -> new BlockEntityType<>(BlockEntityDeconstructionTable::new, Set.of(TCBlocks.DECONSTRUCTION_TABLE.get()), null)
            );

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityArcaneWorkbench>> ARCANE_WORKBENCH =
            BLOCK_ENTITIES.register(
                    "arcane_workbench",
                    () -> new BlockEntityType<>(BlockEntityArcaneWorkbench::new, Set.of(TCBlocks.ARCANE_WORKBENCH.get()), null)
            );
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntitySpa>> SPA =
            BLOCK_ENTITIES.register(
                    "spa",
                    () -> new BlockEntityType<>(BlockEntitySpa::new, Set.of(TCBlocks.SPA.get()), null)
            );

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntitySmelter>> SMELTER =
            BLOCK_ENTITIES.register(
                    "smelter",
                    () -> new BlockEntityType<>(BlockEntitySmelter::new, Set.of(TCBlocks.SMELTER_BASIC.get(),TCBlocks.SMELTER_THAUMIUM.get(),TCBlocks.SMELTER_VOID.get()), null)
            );
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityThaumatorium>> THAUMATORIUM =
            BLOCK_ENTITIES.register(
                    "thaumatorium",
                    () -> new BlockEntityType<>(BlockEntityThaumatorium::new, Set.of(TCBlocks.THAUMATORIUM.get()), null)
            );

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityThaumatoriumTop>> THAUMATORIUM_TOP =
            BLOCK_ENTITIES.register(
                    "thaumatorium_top",
                    () -> new BlockEntityType<>(BlockEntityThaumatoriumTop::new, Set.of(TCBlocks.THAUMATORIUM_TOP.get()), null)
            );
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityRedstoneRelay>> REDSTONE_RELAY =
            BLOCK_ENTITIES.register(
                    "redstone_relay",
                    () -> new BlockEntityType<>(BlockEntityRedstoneRelay::new, Set.of(TCBlocks.REDSTONE_RELAY.get()), null)
            );
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityEverfullUrn>> EVERFULL_URN =
            BLOCK_ENTITIES.register(
                    "everfull_urn",
                    () -> new BlockEntityType<>(BlockEntityEverfullUrn::new, Set.of(TCBlocks.EVERFULL_URN.get()), null)
            );

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityVisGenerator>> VIS_GENERATOR =
            BLOCK_ENTITIES.register(
                    "vis_generator",
                    () -> new BlockEntityType<>(BlockEntityVisGenerator::new, Set.of(TCBlocks.VIS_GENERATOR.get()), null)
            );
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityEssentiaPort>> ESSENTIA_PORT =
            BLOCK_ENTITIES.register(
                    ...
                    () -> new BlockEntityType<>(BlockEntityEssentiaPort::new,
                            Set.of(TCBlocks.ESSENTIA_INPUT.get(), TCBlocks.ESSENTIA_OUTPUT.get()), null)
            );
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityArcaneEar>> ARCANE_EAR =
            BLOCK_ENTITIES.register(
                    ...
                    () -> new BlockEntityType<>(BlockEntityArcaneEar::new,
                            Set.of(TCBlocks.ARCANE_EAR.get(), TCBlocks.ARCANE_EAR_TOGGLE.get()), null)
            );
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityLampFertility>> LAMP_FERTILITY =
            BLOCK_ENTITIES.register(
                    "lamp_fertility",
                    () -> new BlockEntityType<>(BlockEntityLampFertility::new, Set.of(TCBlocks.LAMP_FERTILITY.get()), null)
            );
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityHungryChest>> HUNGRY_CHEST =
            BLOCK_ENTITIES.register(
                    "hungry_chest",
                    () -> new BlockEntityType<>(BlockEntityHungryChest::new, Set.of(TCBlocks.HUNGRY_CHEST.get()), null)
            );

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityEldritchAltar>> ELDRITCH_ALTAR =
            BLOCK_ENTITIES.register(
                    "eldritch_altar",
                    () -> new BlockEntityType<>(BlockEntityEldritchAltar::new, Set.of(TCBlocks.ELDRITCH_ALTAR.get()), null)
            );

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityEldritchObelisk>> ELDRITCH_OBELISK =
            BLOCK_ENTITIES.register(
                    "eldritch_obelisk",
                    () -> new BlockEntityType<>(BlockEntityEldritchObelisk::new, Set.of(TCBlocks.ELDRITCH_OBELISK.get()), null)
            );

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityEldritchLock>> ELDRITCH_LOCK =
            BLOCK_ENTITIES.register(
                    "eldritch_lock",
                    () -> new BlockEntityType<>(BlockEntityEldritchLock::new, Set.of(TCBlocks.ELDRITCH_LOCK.get()), null)
            );
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityTube>> TUBE =
            BLOCK_ENTITIES.register(
                    "tube",
                    () -> new BlockEntityType<>(BlockEntityTube::new, Set.of(TCBlocks.TUBE.get()), null)
            );
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityTubeRestrict>> TUBE_RESTRICT =
            BLOCK_ENTITIES.register(
                    "tube_restrict",
                    () -> new BlockEntityType<>(BlockEntityTubeRestrict::new, Set.of(TCBlocks.TUBE_RESTRICT.get()), null)
            );
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityNitor>> NITOR =
            BLOCK_ENTITIES.register(
                    ...
                    () -> new BlockEntityType<>(BlockEntityNitor::new,
                            TCBlocks.NITORS.values().stream().map(b -> (Block) b.get()).collect(Collectors.toSet()), null)
            );

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityInfernalFurnace>> INFERNAL_FURNACE =
            BLOCK_ENTITIES.register(
                    "infernal_furnace",
                    () -> new BlockEntityType<>(BlockEntityInfernalFurnace::new, Set.of(TCBlocks.INFERNAL_FURNACE.get()), null)
            );

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityInfusionMatrix>> INFUSION_MATRIX =
            BLOCK_ENTITIES.register(
                    "infusion_matrix",
                    () -> new BlockEntityType<>(BlockEntityInfusionMatrix::new, Set.of(TCBlocks.INFUSION_MATRIX.get()), null)
            );
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityPedestal>> PEDESTAL =
            BLOCK_ENTITIES.register(
                    ...
                    () -> new BlockEntityType<>(BlockEntityPedestal::new,
                            Set.of(TCBlocks.PEDESTAL_ARCANE.get(), TCBlocks.PEDESTAL_ANCIENT.get(), TCBlocks.PEDESTAL_ELDRITCH.get()), null)
            );

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityRechargePedestal>> RECHARGE_PEDESTAL =
            BLOCK_ENTITIES.register(
                    "recharge_pedestal",
                    () -> new BlockEntityType<>(BlockEntityRechargePedestal::new, Set.of(TCBlocks.RECHARGE_PEDESTAL.get()), null)
            );

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityPatternCrafter>> PATTERN_CRAFTER =
            BLOCK_ENTITIES.register(
                    "pattern_crafter",
                    () -> new BlockEntityType<>(BlockEntityPatternCrafter::new, Set.of(TCBlocks.PATTERN_CRAFTER.get()), null)
            );

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityPotionSprayer>> POTION_SPRAYER =
            BLOCK_ENTITIES.register(
                    "potion_sprayer",
                    () -> new BlockEntityType<>(BlockEntityPotionSprayer::new, Set.of(TCBlocks.POTION_SPRAYER.get()), null)
            );
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityGolemBuilder>> GOLEM_BUILDER =
            BLOCK_ENTITIES.register(
                    "golem_builder",
                    () -> new BlockEntityType<>(BlockEntityGolemBuilder::new, Set.of(TCBlocks.GOLEM_BUILDER.get()), null)
            );

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<BlockEntityHole>> HOLE =
            BLOCK_ENTITIES.register(
                    "hole",
                    () -> new BlockEntityType<>(BlockEntityHole::new, Set.of(TCBlocks.HOLE.get()), null)
            );
