...
public sealed interface BlueprintSource {
    ...
    enum Kind implements StringRepresentable {
        BLOCK("block", BlockSource.CODEC_INSTANCE, BlockSource.STREAM_CODEC_INSTANCE),
        STATE("state", StateSource.CODEC_INSTANCE, StateSource.STREAM_CODEC_INSTANCE),
        TAG("tag", TagSource.CODEC_INSTANCE, TagSource.STREAM_CODEC_INSTANCE);
