...
public record ArcaneCraftCost(
    ...
    /**
     * Binds the cost factory. Called once at mod init by Thaumcraft; addons must not call this.
     *
    ...
    /**
     * Implementation hook supplied by Thaumcraft that computes a cost from a recipe, workbench, and
