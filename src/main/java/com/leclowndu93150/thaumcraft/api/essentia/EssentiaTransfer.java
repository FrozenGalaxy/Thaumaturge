 ...
 *
 * <p>The core flow in Thaumcraft moves a single unit per tick; addons that pipe essentia at scale
...
public final class EssentiaTransfer {
     ...
     */
    public static int transfer(IEssentiaTransport src, Direction srcFace,
                               IEssentiaTransport dst, Direction dstFace,
                               Holder<IAspect> aspect, int max, boolean simulate) {
        if (max <= 0) {
            return 0;
        }
     ...
     */
    public static int transfer(Level level, BlockPos srcPos, Direction srcFace,
                               BlockPos dstPos, Direction dstFace,
                               Holder<IAspect> aspect, int max, boolean simulate) {
