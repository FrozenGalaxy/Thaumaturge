...
public final class FocusEngine {
     ...
     */
    public static @Nullable FocusElementType type(ResourceLocation key) {
     ...
     */
    public static @Nullable FocusElement element(ResourceLocation key) {
     ...
     */
    public static @Nullable ResourceLocation icon(ResourceLocation key) {
        FocusElementType type = registry().get(key);
     ...
     *         under {@code key}
     */
    public static int color(ResourceLocation key) {
        FocusElementType type = registry().get(key);
    ...
    public static void cast(LivingEntity caster, FocusPackage pack, CastStreams origin) {
        for (ResourceLocation effectId : effectIds(pack.units())) {
     ...
     */
    public static void run(Level level, FocusPackage pack, Trajectory @Nullable [] trajectories,
            HitResult @Nullable [] targets) {
     ...
     */
    public static List<ResourceLocation> effectIds(FocusPackage pack) {
     ...
     * @return the effect ids in encounter order; empty when none
     */
    public static List<ResourceLocation> effectIds(List<FocusUnit> units) {
        List<ResourceLocation> out = new ArrayList<>();
        collectEffectIds(units, out);
        return out;
    }

    private static void collectEffectIds(List<FocusUnit> units, List<ResourceLocation> out) {
