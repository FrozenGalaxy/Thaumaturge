...
public class ScanAspect implements IScanThing {
    ...
    public void onSuccess(Player player, @Nullable Object target) {
        ScanningManager.addKnowledge(player, KnowledgeType.OBSERVATION,
                TCResearchCategories.AUROMANCY.location(), DISCOVERY_OBSERVATION_POINTS);
        ScanningManager.addKnowledge(player, KnowledgeType.OBSERVATION,
                TCResearchCategories.BASICS.location(), DISCOVERY_OBSERVATION_POINTS);
        ScanningManager.addKnowledge(player, KnowledgeType.OBSERVATION,
                TCResearchCategories.ALCHEMY.location(), DISCOVERY_OBSERVATION_POINTS);
    }
