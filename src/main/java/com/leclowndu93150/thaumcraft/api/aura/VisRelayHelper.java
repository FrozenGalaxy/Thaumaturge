...
public final class VisRelayHelper {
    ...
    public interface Bindings {
         ...
         */
        int drainCentivis(ServerLevel level, BlockPos consumerPos, ResourceKey<IAspect> primal,
     ...
     */
    public static int drainCentivis(ServerLevel level, BlockPos consumerPos,
