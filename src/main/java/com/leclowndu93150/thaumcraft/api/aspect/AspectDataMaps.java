 ...
 * {@code thaumcraft:base_aspects}. Addons declare item aspects by shipping a data map entry file at
 ...
 * {@code thaumcraft:entity_aspects}, consumed by the scanning system.
 *
...
public final class AspectDataMaps {
    /** Item-to-aspect base assignments, keyed {@code thaumcraft:base_aspects}. */
    public static final DataMapType<Item, AspectList> BASE_ASPECTS = DataMapType.builder(
            ResourceLocation.fromNamespaceAndPath("thaumcraft", "base_aspects"),
            Registries.ITEM,
            AspectList.CODEC
    ).synced(AspectList.CODEC, false).build();

    /** Entity-to-aspect assignments, keyed {@code thaumcraft:entity_aspects}. */
    public static final DataMapType<EntityType<?>, AspectList> ENTITY_ASPECTS = DataMapType.builder(
            ResourceLocation.fromNamespaceAndPath("thaumcraft", "entity_aspects"),
