 ...
 *
 * <p>The implementation is bound once at mod init by Thaumcraft via {@link #bind(Supplier)}; addons
...
public final class AspectIndexAccess {
    ...
    /**
     * Binds the facade's implementation. Called once at mod init by Thaumcraft; addons must not
     * call this.
     *
