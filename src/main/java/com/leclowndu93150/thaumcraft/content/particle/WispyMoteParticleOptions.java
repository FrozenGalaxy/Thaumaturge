...
public record WispyMoteParticleOptions(
        int color,
        int age,
        float gravity,
        int targetEntityId
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, WispyMoteParticleOptions> STREAM_CODEC = StreamCodec.composite(
            ByteBufCodecs.INT, WispyMoteParticleOptions::color,
            ByteBufCodecs.VAR_INT, WispyMoteParticleOptions::age,
            ByteBufCodecs.FLOAT, WispyMoteParticleOptions::gravity,
            ByteBufCodecs.VAR_INT, WispyMoteParticleOptions::targetEntityId,
