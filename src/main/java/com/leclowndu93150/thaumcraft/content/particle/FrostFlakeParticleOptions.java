...
public record FrostFlakeParticleOptions(float scale) implements ParticleOptions {
    ...
    public static final MapCodec<FrostFlakeParticleOptions> CODEC =
            Codec.FLOAT.xmap(FrostFlakeParticleOptions::new, FrostFlakeParticleOptions::scale).fieldOf("scale");
