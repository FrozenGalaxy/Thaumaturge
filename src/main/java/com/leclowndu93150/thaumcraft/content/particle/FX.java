...
import com.leclowndu93150.thaumcraft.network.ClientboundSpawnParticlePayload;
...
public final class FX {
    ...
    public static BeamWand beamWand(ServerLevel level, net.minecraft.world.entity.LivingEntity source) { return new BeamWand(level, source); }
    public static BeamBore beamBore(ServerLevel level, Vec3 source) { return new BeamBore(level, source); }
    public static BoreParticles boreParticles(ServerLevel level, Vec3 pos, net.minecraft.world.level.block.state.BlockState state) { return new BoreParticles(level, pos, state); }
    public static BoreSparkle boreSparkle(ServerLevel level, Vec3 pos) { return new BoreSparkle(level, pos); }
    public static BoreStream boreStream(ServerLevel level, Vec3 source, net.minecraft.world.entity.Entity target) { return new BoreStream(level, source, target); }
    ...
    static void spawn(ServerLevel level, net.minecraft.core.particles.ParticleOptions data, double x, double y, double z) {
        PacketDistributor.sendToPlayersNear(level, null, x, y, z, DEFAULT_RADIUS,
                new ClientboundSpawnParticlePayload(data, x, y, z));
    }
    ...
    public static final class Vent {
        ...
        public void send() {
            ...
            net.neoforged.neoforge.network.PacketDistributor.sendToPlayersNear(level, null,
                    ...
                    new com.leclowndu93150.thaumcraft.network.ClientboundSpawnParticlePayload(data, pos.x, pos.y, pos.z));
    ...
    public static final class BeamWand {
        private final ServerLevel level;
        private final net.minecraft.world.entity.LivingEntity source;
        ...
        BeamWand(ServerLevel level, net.minecraft.world.entity.LivingEntity source) { this.level = level; this.source = source; }
        ...
        public void send() {
            ...
            com.leclowndu93150.thaumcraft.network.ClientboundBeamPayload payload =
                    new com.leclowndu93150.thaumcraft.network.ClientboundBeamPayload(
        ...
        public void send() {
            ...
            com.leclowndu93150.thaumcraft.network.ClientboundBeamPayload payload =
                    new com.leclowndu93150.thaumcraft.network.ClientboundBeamPayload(
                            ...
                            com.leclowndu93150.thaumcraft.client.render.beam.BeamPayloadIds.NO_ENTITY, true);
            PacketDistributor.sendToPlayersNear(level, null,
    ...
    public static final class BlockMist {
        ...
        public void send() {
            RandomSource rand = level.getRandom();
            net.minecraft.world.phys.AABB bs = level.getBlockState(pos).getShape(level, pos).bounds();
            float cr = ((color >> 16) & 0xFF) / 255.0F;
            float cg = ((color >> 8) & 0xFF) / 255.0F;
            float cb = (color & 0xFF) / 255.0F;
            for (int a = 0; a < 8; a++) {
    ...
    public static final class BlockSparkles {
        ...
        public void send() {
            RandomSource rand = level.getRandom();
            net.minecraft.world.phys.AABB bs = level.getBlockState(pos).getShape(level, pos).bounds().inflate(0.1);
            ...
            for (Direction face : Direction.values()) {
                ...
                for (int a = 0; a < num * 2; a++) {
                    ...
                    x = net.minecraft.util.Mth.clamp(x, bs.minX, bs.maxX);
                    y = net.minecraft.util.Mth.clamp(y, bs.minY, bs.maxY);
                    z = net.minecraft.util.Mth.clamp(z, bs.minZ, bs.maxZ);
                    float r = 1.0F;
    ...
    public static final class BoreParticles {
        ...
        BoreParticles(ServerLevel level, Vec3 pos, net.minecraft.world.level.block.state.BlockState state) {
            this.level = level;
            this.pos = pos;
            this.state = state;
        }
    ...
    public static final class BoreStream {
        ...
        BoreStream(ServerLevel level, Vec3 source, net.minecraft.world.entity.Entity target) {
            this.level = level;
            this.source = source;
            this.target = target;
        }
        ...
        public void send() {
            com.leclowndu93150.thaumcraft.network.ClientboundBoreStreamPayload payload =
                    new com.leclowndu93150.thaumcraft.network.ClientboundBoreStreamPayload(
                            source.x, source.y, source.z,
    ...
    public static final class VoidStream {
        ...
        public void send() {
            if (target == null) return;
            com.leclowndu93150.thaumcraft.network.ClientboundVoidStreamPayload payload =
                    new com.leclowndu93150.thaumcraft.network.ClientboundVoidStreamPayload(
                            source.x, source.y, source.z,
                            target.x, target.y, target.z,
                            seed, scale);
            PacketDistributor.sendToPlayersNear(level, null,
