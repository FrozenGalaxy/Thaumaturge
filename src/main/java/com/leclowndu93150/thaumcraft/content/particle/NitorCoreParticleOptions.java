...
public record NitorCoreParticleOptions(float r, float g, float b) implements ParticleOptions {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, NitorCoreParticleOptions> STREAM_CODEC = StreamCodec.composite(
            ByteBufCodecs.FLOAT, NitorCoreParticleOptions::r,
            ByteBufCodecs.FLOAT, NitorCoreParticleOptions::g,
            ByteBufCodecs.FLOAT, NitorCoreParticleOptions::b,
