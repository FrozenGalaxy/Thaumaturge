...
public record TaintFumeParticleOptions(int color, float scale) implements ParticleOptions {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, TaintFumeParticleOptions> STREAM_CODEC = StreamCodec.composite(
            ByteBufCodecs.INT, TaintFumeParticleOptions::color,
            ByteBufCodecs.FLOAT, TaintFumeParticleOptions::scale,
