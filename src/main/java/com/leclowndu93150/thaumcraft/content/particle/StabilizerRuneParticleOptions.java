...
public record StabilizerRuneParticleOptions(int life) implements ParticleOptions {
    ...
    public static final MapCodec<StabilizerRuneParticleOptions> CODEC =
            Codec.INT.xmap(StabilizerRuneParticleOptions::new, StabilizerRuneParticleOptions::life).fieldOf("life");
