...
public record FlameFanParticleOptions(float scale, float lift, float alpha) implements ParticleOptions {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, FlameFanParticleOptions> STREAM_CODEC = StreamCodec.composite(
            ByteBufCodecs.FLOAT, FlameFanParticleOptions::scale,
            ByteBufCodecs.FLOAT, FlameFanParticleOptions::lift,
            ByteBufCodecs.FLOAT, FlameFanParticleOptions::alpha,
