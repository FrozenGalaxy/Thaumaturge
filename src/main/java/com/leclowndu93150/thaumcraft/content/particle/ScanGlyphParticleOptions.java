...
public record ScanGlyphParticleOptions(int color, int delay, boolean additive) implements ParticleOptions {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, ScanGlyphParticleOptions> STREAM_CODEC = StreamCodec.composite(
            ByteBufCodecs.INT, ScanGlyphParticleOptions::color,
            ByteBufCodecs.VAR_INT, ScanGlyphParticleOptions::delay,
            ByteBufCodecs.BOOL, ScanGlyphParticleOptions::additive,
