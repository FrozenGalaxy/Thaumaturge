...
import com.leclowndu93150.thaumcraft.network.ClientboundSealPayload;
...
public final class SealEntity implements ISealEntity {
    ...
    public boolean isStoppedByRedstone(Level level) {
        return isRedstoneSensitive()
                && (level.hasNeighborSignal(sealPos.pos()) || level.hasNeighborSignal(sealPos.pos().relative(sealPos.face())));
    }
