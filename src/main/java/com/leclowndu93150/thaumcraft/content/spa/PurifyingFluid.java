...
public abstract class PurifyingFluid extends BaseFlowingFluid {
    ...
    public static void applyEntityInside(Level level, BlockPos pos, Entity entity) {
        ...
        if (!level.isClientSide() && fs.isSource() && entity instanceof ServerPlayer player
            ...
            player.addEffect(new MobEffectInstance(TCMobEffects.WARP_WARD,
                    Math.min(WARD_MAX_TICKS, WARD_BUDGET_TICKS / div), 0, true, true));
