package com.leclowndu93150.thaumcraft.content.research.decon;
...
public final class BlockEntityDeconstructionTable extends BlockEntity implements MenuProvider {
    ...
    private static final Component TITLE = Component.translatable("gui.thaumcraft.deconstruction_table.title");
    ...
    protected void loadAdditional(CompoundTag input, HolderLookup.Provider registries) {
        ...
        resultAspect = TCNbt.read(input, "result_aspect", ResourceLocation.CODEC, registries).orElse(null);
