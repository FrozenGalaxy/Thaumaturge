...
public final class CardRealization extends TheorycraftCard {
    @Override
    ...
    public Component name() {
        return Component.translatable("card.thaumcraft.realization.name");
    }

    @Override
    public Component description() {
        return Component.translatable("card.thaumcraft.realization.text");
    }
    ...
    public boolean activate(ServerPlayer player, IResearchTableData data) {
        ...
        data.addCategoryTotal(CardHelper.randomCategory(player), Mth.nextInt(player.getRandom(), 5, 10));
        data.addCategoryTotal(TCResearchCategories.ELDRITCH, 15);
