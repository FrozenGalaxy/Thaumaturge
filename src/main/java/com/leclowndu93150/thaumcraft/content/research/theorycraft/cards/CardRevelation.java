...
public final class CardRevelation extends TheorycraftCard {
    @Override
    ...
    public Component name() {
        return Component.translatable("card.thaumcraft.revelation.name");
    }

    @Override
    public Component description() {
        return Component.translatable("card.thaumcraft.revelation.text");
    }
    ...
    public boolean activate(ServerPlayer player, IResearchTableData data) {
        ...
        data.addCategoryTotal(TCResearchCategories.ELDRITCH, 30);
