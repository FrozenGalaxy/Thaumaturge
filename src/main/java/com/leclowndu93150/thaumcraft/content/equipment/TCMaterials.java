...
public final class TCMaterials {
    public static final ToolMaterial TOOL_THAUMIUM = new ToolMaterial(
            BlockTags.INCORRECT_FOR_DIAMOND_TOOL, 500, 7.0F, 2.5F, 22, TCItemTags.INGOTS_THAUMIUM);
    public static final ToolMaterial TOOL_VOID = new ToolMaterial(
    ...
    public static final ArmorMaterial ARMOR_THAUMIUM = new ArmorMaterial(
            25, defense(2, 5, 6, 2), 25, SoundEvents.ARMOR_EQUIP_IRON,
            1.0F, 0.0F, TCItemTags.INGOTS_THAUMIUM, ASSET_THAUMIUM);
    ...
    public static final ArmorMaterial ARMOR_VOID_ROBE = new ArmorMaterial(
            18, defense(4, 7, 9, 4), 10, SoundEvents.ARMOR_EQUIP_LEATHER,
            2.0F, 0.0F, TCItemTags.INGOTS_VOID_METAL, ASSET_VOID_ROBE);
    public static final ArmorMaterial ARMOR_FORTRESS = new ArmorMaterial(
            40, defense(3, 6, 7, 3), 25, SoundEvents.ARMOR_EQUIP_IRON,
            3.0F, 0.0F, TCItemTags.INGOTS_THAUMIUM, ASSET_FORTRESS);
    public static final ArmorMaterial ARMOR_CULTIST_PLATE = new ArmorMaterial(
            18, defense(2, 5, 6, 2), 13, SoundEvents.ARMOR_EQUIP_IRON,
            0.0F, 0.0F, Tags.Items.INGOTS_IRON, ASSET_CULTIST_PLATE);
