package com.leclowndu93150.thaumcraft.data.worldgen.pech;
...
import com.leclowndu93150.thaumcraft.content.pech.PechTradeTable.PechTrade;
...
public final class PechTradeBootstrap {
    ...
    private static PechTrade crystal(HolderGetter<IAspect> aspects, int tier, ResourceKey<IAspect> aspect) {
        ...
        stack.set(TCDataComponents.CRYSTAL_ASPECT.get(), new AspectInstance(aspects.getOrThrow(aspect), 1));
