...
public final class TCItemsHContainersModels {
    ...
    private static void registerPhial(ItemModelGenerators itemModels) {
        Identifier phialModel = itemModels.createFlatItemModel(TCItemsHContainers.PHIAL.get(), ModelTemplates.FLAT_ITEM);
        Identifier filledModel = itemModels.generateLayeredItem(ModelLocationUtils.getModelLocation(TCItemsHContainers.PHIAL.get(),"_filled"), TextureMapping.getItemTexture(TCItemsHContainers.PHIAL.get()),TextureMapping.getItemTexture(TCItemsHContainers.PHIAL.get(),"_overlay"));
