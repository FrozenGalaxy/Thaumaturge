...
public final class TCEntityLootSubProvider extends EntityLootSubProvider {
    ...
    public void generate() {
        add(TCEntities.BRAINY_ZOMBIE.get(), LootTable.lootTable()
                .withPool(fleshPool())
        ...
        add(TCEntities.GIANT_BRAINY_ZOMBIE.get(), LootTable.lootTable()
                .withPool(LootPool.lootPool()
    ...
    private LootPool.Builder brainPool() {
        return LootPool.lootPool()
                ...
                .add(LootItem.lootTableItem(TCItems.BRAIN.get())
                        .when(LootItemRandomChanceWithEnchantedBonusCondition
                                .randomChanceAndLootingBoost(this.registries, BRAIN_CHANCE, BRAIN_LOOTING_BONUS)));
    }
}
