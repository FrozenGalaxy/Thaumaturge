...
public final class TCLangDecor {
    ...
    public static void register(LanguageProvider provider) {
        ...
        provider.add("block.thaumcraft.everfull_urn", "Everfull Urn");
        provider.add("block.thaumcraft.vis_generator", "Vis Generator");
        provider.add("block.thaumcraft.essentia_input", "Filling Essentia Transfuser");
        provider.add("block.thaumcraft.essentia_output", "Emptying Essentia Transfuser");
        provider.add("block.thaumcraft.condenser", "Flux Condenser");
        provider.add("block.thaumcraft.condenser_lattice", "Flux Condenser Lattice");
        provider.add("block.thaumcraft.condenser_lattice_dirty", "Clogged Flux Condenser Lattice");
        provider.add("block.thaumcraft.stabilizer", "Stabilizer");
        provider.add("block.thaumcraft.redstone_relay", "Redstone Relay");
        provider.add("block.thaumcraft.void_siphon", "Void Siphon");
        provider.add("block.thaumcraft.thaumatorium", "Thaumatorium");
