        ...
        public void submit(PoseStack poseStack, SubmitNodeCollector collector, int lightCoords,
            ...
            if (glowingInvisible) {
                collector.order(1).submitModel(this.model, state, poseStack,
                        RenderTypes.outline(TEXTURE), lightCoords, overlayCoords, state.outlineColor, null);
            } else {
                collector.order(1).submitModel(this.model, state, poseStack,
                        RenderTypes.entityTranslucent(TEXTURE), lightCoords, overlayCoords, state.outlineColor, null);
            }
        }
    }
}
