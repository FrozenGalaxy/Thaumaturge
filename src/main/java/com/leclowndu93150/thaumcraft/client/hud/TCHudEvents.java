...
public final class TCHudEvents {
    ...
    public static void registerLayers(RegisterGuiLayersEvent event) {
        event.registerAbove(VanillaGuiLayers.EXPERIENCE_LEVEL, TCIds.rl("left_hud_stack"), new LeftHudStack(List.of(
                CasterHudOverlay.dialGauge(), new AuraHudOverlay(), new SanityHudOverlay())));
