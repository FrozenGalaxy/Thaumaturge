...
public final class RobeArmorModel extends HumanoidModel<HumanoidRenderState> {
    ...
    public static LayerDefinition createHead() {
        ...
        head.addOrReplaceChild("hood1",
                CubeListBuilder.create().texOffs(16, 7).addBox(-4.5F, -9.0F, -4.6F, 9, 9, 9), PartPose.ZERO);
    ...
    public static LayerDefinition createChest() {
        ...
        body.addOrReplaceChild("chestplate",
                CubeListBuilder.create().texOffs(16, 25).addBox(-4.0F, 1.0F, -3.0F, 8, 6, 1), PartPose.ZERO);
        body.addOrReplaceChild("chestthing",
                CubeListBuilder.create().texOffs(56, 50).addBox(-2.5F, 1.0F, -4.0F, 5, 7, 1), PartPose.ZERO);
        ...
        body.addOrReplaceChild("backplate",
                CubeListBuilder.create().texOffs(36, 45).addBox(-4.0F, 1.0F, 1.9F, 8, 11, 2), PartPose.ZERO);
        ...
        body.addOrReplaceChild("clothchest_l",
                CubeListBuilder.create().texOffs(108, 38).mirror().addBox(2.1F, 0.5F, -3.5F, 2, 8, 1), PartPose.ZERO);
        body.addOrReplaceChild("clothchest_r",
                CubeListBuilder.create().texOffs(108, 38).addBox(-4.1F, 0.5F, -3.5F, 2, 8, 1), PartPose.ZERO);
        PartDefinition rightArm = root.getChild("right_arm");
        rightArm.addOrReplaceChild("shoulder_r",
                CubeListBuilder.create().texOffs(16, 45).mirror().addBox(-3.5F, -2.5F, -2.5F, 5, 5, 5), PartPose.ZERO);
        rightArm.addOrReplaceChild("r_arm1",
                CubeListBuilder.create().texOffs(88, 39).addBox(-3.5F, 2.5F, -2.5F, 5, 7, 5), PartPose.ZERO);
        rightArm.addOrReplaceChild("r_arm2",
                CubeListBuilder.create().texOffs(76, 32).addBox(-3.0F, 5.5F, 2.5F, 4, 4, 2), PartPose.ZERO);
        rightArm.addOrReplaceChild("r_arm3",
                CubeListBuilder.create().texOffs(88, 32).addBox(-2.5F, 3.5F, 2.5F, 3, 2, 1), PartPose.ZERO);
        ...
        leftArm.addOrReplaceChild("shoulder_l",
                CubeListBuilder.create().texOffs(16, 45).addBox(-1.5F, -2.5F, -2.5F, 5, 5, 5), PartPose.ZERO);
        leftArm.addOrReplaceChild("l_arm1",
                CubeListBuilder.create().texOffs(88, 39).mirror().addBox(-1.5F, 2.5F, -2.5F, 5, 7, 5), PartPose.ZERO);
        leftArm.addOrReplaceChild("l_arm2",
                CubeListBuilder.create().texOffs(76, 32).addBox(-1.0F, 5.5F, 2.5F, 4, 4, 2), PartPose.ZERO);
        leftArm.addOrReplaceChild("l_arm3",
                CubeListBuilder.create().texOffs(88, 32).addBox(-0.5F, 3.5F, 2.5F, 3, 2, 1), PartPose.ZERO);
    ...
    public static LayerDefinition createLegs() {
        ...
        PartDefinition body = root.getChild("body");
        addBelts(body);
        body.addOrReplaceChild("frontcloth_r1",
        ...
        body.addOrReplaceChild("frontcloth_r2",
        ...
        body.addOrReplaceChild("frontcloth_l1",
        ...
        body.addOrReplaceChild("frontcloth_l2",
        ...
        body.addOrReplaceChild("clothback_r1",
        ...
        body.addOrReplaceChild("clothback_r2",
        ...
        body.addOrReplaceChild("clothback_l2",
        ...
        body.addOrReplaceChild("clothback_l3",
    ...
    private static void addBelts(PartDefinition body) {
        body.addOrReplaceChild("mbelt",
                CubeListBuilder.create().texOffs(16, 55).addBox(-4.0F, 7.0F, -3.0F, 8, 5, 1), PartPose.ZERO);
        body.addOrReplaceChild("mbelt_b",
        ...
        body.addOrReplaceChild("mbelt_l",
                CubeListBuilder.create().texOffs(16, 36).addBox(4.0F, 8.0F, -3.0F, 1, 3, 6), PartPose.ZERO);
        body.addOrReplaceChild("mbelt_r",
                CubeListBuilder.create().texOffs(16, 36).addBox(-5.0F, 8.0F, -3.0F, 1, 3, 6), PartPose.ZERO);
    }
