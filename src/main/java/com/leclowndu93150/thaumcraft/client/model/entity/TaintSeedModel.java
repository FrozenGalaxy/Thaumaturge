...
public final class TaintSeedModel extends HierarchicalModel<AbstractTaintSeed> {
    ...
    public static LayerDefinition createLayer() {
        ...
        PartDefinition parent = mesh.getRoot().addOrReplaceChild("base",
        ...
        for (int k = 0; k < LENGTH - 1; k++) {
            ...
            if (k < LENGTH - 4) {
                ...
                cube = CubeListBuilder.create().texOffs(0, k == LENGTH - 4 ? 48 : 56)
                        .addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F);
            }
            parent = parent.addOrReplaceChild("seg" + k, cube,
                    PartPose.offset(0.0F, SEGMENT_BASE_Y[k], 0.0F));
        }
