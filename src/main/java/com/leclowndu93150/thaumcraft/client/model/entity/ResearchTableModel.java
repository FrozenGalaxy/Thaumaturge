...
public final class ResearchTableModel {
    ...
    public static LayerDefinition createLayer() {
        ...
        table.addOrReplaceChild("top",
                CubeListBuilder.create().texOffs(0, 0).mirror().addBox(0.0F, 0.0F, 0.0F, 32.0F, 4.0F, 16.0F),
                PartPose.offset(-8.0F, 0.0F, -8.0F));
        table.addOrReplaceChild("leg1",
                CubeListBuilder.create().texOffs(0, 24).mirror().addBox(0.0F, 0.0F, 0.0F, 4.0F, 12.0F, 4.0F),
                PartPose.offset(-6.0F, 4.0F, -6.0F));
        table.addOrReplaceChild("leg2",
                CubeListBuilder.create().texOffs(0, 24).mirror().addBox(0.0F, 0.0F, 0.0F, 4.0F, 12.0F, 4.0F),
                PartPose.offset(-6.0F, 4.0F, 2.0F));
        table.addOrReplaceChild("leg3",
                CubeListBuilder.create().texOffs(0, 24).mirror().addBox(0.0F, 0.0F, 0.0F, 4.0F, 12.0F, 4.0F),
                PartPose.offset(18.0F, 4.0F, -6.0F));
        table.addOrReplaceChild("leg4",
                CubeListBuilder.create().texOffs(0, 24).mirror().addBox(0.0F, 0.0F, 0.0F, 4.0F, 12.0F, 4.0F),
                PartPose.offset(18.0F, 4.0F, 2.0F));
        table.addOrReplaceChild("crossbar",
                CubeListBuilder.create().texOffs(24, 24).mirror().addBox(0.0F, 0.0F, 0.0F, 24.0F, 4.0F, 4.0F),
                PartPose.offset(-4.0F, 10.0F, -2.0F));
        root.addOrReplaceChild("inkwell",
                CubeListBuilder.create().texOffs(0, 44).mirror().addBox(0.0F, 0.0F, 0.0F, 3.0F, 2.0F, 3.0F),
                PartPose.offset(-6.0F, -2.0F, 3.0F));
        root.addOrReplaceChild("scroll_tube",
        ...
        root.addOrReplaceChild("scroll_ribbon",
