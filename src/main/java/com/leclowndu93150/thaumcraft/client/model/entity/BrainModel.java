...
public final class BrainModel {
    ...
    public static LayerDefinition createLayer() {
        ...
        root.addOrReplaceChild("lobe",
                CubeListBuilder.create().texOffs(0, 0).mirror().addBox(0.0F, 0.0F, 0.0F, 12.0F, 10.0F, 16.0F),
                PartPose.offset(-6.0F, 8.0F, -8.0F));
        root.addOrReplaceChild("cerebellum",
                CubeListBuilder.create().texOffs(64, 0).mirror().addBox(0.0F, 0.0F, 0.0F, 8.0F, 3.0F, 7.0F),
