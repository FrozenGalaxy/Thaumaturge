...
import com.leclowndu93150.thaumcraft.client.effect.instance.BoreDigEffect;
import com.leclowndu93150.thaumcraft.client.effect.manager.BoreDigEffectManager;
    ...
    public static void handle(ClientboundBoreDigPayload payload, IPayloadContext context) {
        context.enqueueWork(() -> {
            ...
            BoreDigEffectManager.INSTANCE.add(new BoreDigEffect(
                    level, payload.target(), payload.boreEntityId(), state, payload.delay()));
        });
    }
}
