...
import com.leclowndu93150.thaumcraft.client.render.blockentity.LegacyItemLift;
...
public final class ItemRenderHelper {
    ...
    public static void render(ItemStack stack, ItemDisplayContext context, PoseStack pose,
                              MultiBufferSource buffers, int light, int overlay, int seed) {
        Minecraft minecraft = Minecraft.getInstance();
        minecraft.getItemRenderer().renderStatic(stack, context, light, overlay, pose, buffers, minecraft.level, seed);
    }

    public static void renderGroundCentered(ItemStack stack, PoseStack pose, MultiBufferSource buffers,
