...
public final class RechargePedestalRenderer
        implements BlockEntityRenderer<BlockEntityRechargePedestal> {
    ...
    @Override
    public void render(BlockEntityRechargePedestal pedestal, float partialTick, PoseStack poseStack,
        ...
        LateWorldRenderQueue.enqueue(origin, (latePose, lateBuffers) ->
                FloatyLineRenderer.draw(latePose, lateBuffers, from, time, color, LINE_SPEED, 1.0F, LINE_WIDTH));
    }
