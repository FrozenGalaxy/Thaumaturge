...
public final class TCFlatRenderTypes {
    private static final Function<Identifier, RenderType> CUTOUT_FLAT = Util.memoize(
    ...
    private static final Function<Identifier, RenderType> TRANSLUCENT_FLAT = Util.memoize(
    ...
    private static final Function<Identifier, RenderType> ADDITIVE_FLAT = Util.memoize(
