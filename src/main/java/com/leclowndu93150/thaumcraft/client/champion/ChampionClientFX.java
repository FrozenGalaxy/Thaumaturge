...
public final class ChampionClientFX {
        ...
        switch (type) {
            case ChampionModifier.BOLD -> {
                if (rand.nextBoolean()) {
                    ...
                    addParticle(level, x, sy, z, new SparkParticleOptions(
                            ARGB32.colorFromFloat(1.0F, 0.3F - rand.nextFloat() * 0.1F, 0.0F, 0.8F + rand.nextFloat() * 0.2F),
                            1.0F, 0.2F));
                }
            }
            case ChampionModifier.SPINED -> {
                if (rand.nextBoolean()) {
                    addParticle(level, x, y, z, new CrackShardParticleOptions(
                            ARGB32.colorFromFloat(1.0F, 0.5F + rand.nextFloat() * 0.2F, 0.1F + rand.nextFloat() * 0.2F,
            ...
            case ChampionModifier.ARMORED -> {
                if (rand.nextInt(4) == 0) {
                    addParticle(level, x, y, z, new ShieldSparkParticleOptions(
                            ARGB32.colorFromFloat(1.0F, 0.9F, 0.9F, 0.9F + rand.nextFloat() * 0.1F),
                            0.7F, 0.6F + rand.nextFloat() * 0.2F, 5 + rand.nextInt(4), true));
                }
            }
            case ChampionModifier.MIGHTY -> {
                if (rand.nextFloat() <= 0.3F) {
                    addParticle(level, x, y, z, new CrackShardParticleOptions(
                            ARGB32.colorFromFloat(1.0F, 0.8F + rand.nextFloat() * 0.2F, 0.8F + rand.nextFloat() * 0.2F,
            ...
            case ChampionModifier.GRIM -> {
                if (rand.nextBoolean()) {
                    addParticle(level, x, y, z, 0.0, -0.02, 0.0, new FlameFanParticleOptions(
                            0.6F + rand.nextFloat() * 0.4F, 0.0F, 0.8F));
                }
            }
            case ChampionModifier.WARDED -> {
                if (rand.nextBoolean()) {
                    addParticle(level, x, y, z, TCParticles.colorOf(TCParticles.LEAF_MOTE,
                            0.5F + rand.nextFloat() * 0.1F, 0.5F + rand.nextFloat() * 0.1F, 0.5F + rand.nextFloat() * 0.1F));
                }
            }
            case ChampionModifier.WARP -> {
                if (rand.nextBoolean()) {
                    addParticle(level, x, y, z, new WispFlameParticleOptions(
                            ARGB32.colorFromFloat(1.0F, 0.8F + rand.nextFloat() * 0.2F, 0.0F, 0.9F + rand.nextFloat() * 0.1F),
                            0.7F, 0.6F + rand.nextFloat() * 0.4F, 0.6F + rand.nextFloat() * 0.4F, 0));
                }
            }
            case ChampionModifier.UNDYING -> {
                if (rand.nextBoolean()) {
                    addParticle(level, x, y, z, 0.0, 0.03, 0.0, new WispFlameParticleOptions(
                            ARGB32.colorFromFloat(1.0F, 0.1F + rand.nextFloat() * 0.1F, 0.8F + rand.nextFloat() * 0.2F, 0.1F + rand.nextFloat() * 0.1F),
                            0.9F, 0.5F + rand.nextFloat() * 0.2F, 0.5F + rand.nextFloat() * 0.2F, 0));
                }
            }
            case ChampionModifier.FIERY -> addParticle(level, x, y, z, 0.0, 0.03, 0.0, new FlameFanParticleOptions(
                    0.7F + rand.nextFloat() * 0.2F, 0.0F, 0.7F));
            case ChampionModifier.SICKLY -> {
                if (rand.nextBoolean()) {
                    addParticle(level, x, y, z, 0.0, -0.02, 0.0, new FluxSwirlParticleOptions(
                            ARGB32.colorFromFloat(1.0F, 0.2F, 0.6F + rand.nextFloat() * 0.1F, 0.2F + rand.nextFloat() * 0.1F),
                            0.9F + rand.nextFloat() * 0.3F, 0.9F));
                }
            }
            case ChampionModifier.VENOMOUS -> {
                if (rand.nextBoolean()) {
                    addParticle(level, x, y, z, 0.0, 0.02, 0.0, TCParticles.colorOf(TCParticles.GOO_DRIP,
                            0.2F, 0.6F + rand.nextFloat() * 0.1F, 0.2F + rand.nextFloat() * 0.1F));
                }
            }
            case ChampionModifier.VAMPIRIC -> {
                if (rand.nextFloat() <= 0.2F) {
                    addParticle(level, x, y, z, TCParticles.colorOf(TCParticles.GOO_DRIP,
                            0.9F + rand.nextFloat() * 0.1F, 0.0F, 0.0F));
                }
            }
            ...
            case ChampionModifier.TAINTED -> addParticle(level, x, y, z, 0.0, -0.01, 0.0, new FluxSwirlParticleOptions(
                    ARGB32.colorFromFloat(0.25F, 0.1F + rand.nextFloat() * 0.2F, 0.0F, 0.1F + rand.nextFloat() * 0.1F),
                    2.0F + rand.nextFloat(), 2.0F));
            default -> {
            }
        }
    }
    ...
    private static void addParticle(Level level, double x, double y, double z,
                                    double vx, double vy, double vz, ParticleOptions options) {
