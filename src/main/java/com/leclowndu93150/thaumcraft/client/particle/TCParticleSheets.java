...
public final class TCParticleSheets {
    ...
    public static ParticleSheet sheet(String name) {
        return SHEETS.computeIfAbsent(name, key -> new ParticleSheet(key,
                ResourceLocation.fromNamespaceAndPath(TCIds.MODID, "textures/particle/" + key + ".png")));
    }
    ...
    static void onRegisterReloadListeners(RegisterClientReloadListenersEvent event) {
        event.registerReloadListener((ResourceManagerReloadListener) manager -> {
            ...
            for (ResourceLocation id : manager.listResources("textures/particle", path -> path.getPath().endsWith(".png")).keySet()) {
