...
public final class WispFlameParticle extends TCParticle {
    ...
    private WispFlameParticle(ClientLevel level, double x, double y, double z,
                              double vx, double vy, double vz, WispFlameParticleOptions options, ParticleSheet sheet) {
    ...
    public static final class Provider implements ParticleProvider<WispFlameParticleOptions> {
        ...
        @Override
        public Particle createParticle(WispFlameParticleOptions options, ClientLevel level, double x, double y, double z,
