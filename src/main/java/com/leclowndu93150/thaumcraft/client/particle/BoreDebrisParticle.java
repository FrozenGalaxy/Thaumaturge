...
public final class BoreDebrisParticle extends SeekerParticle {
    ...
    private BoreDebrisParticle(ClientLevel level, double x, double y, double z,
                               BoreDebrisParticleOptions options, TextureAtlasSprite sprite) {
        super(level, x, y, z, sprite, options.targetEntityId(),
    ...
    public static final class Provider implements ParticleProvider<BoreDebrisParticleOptions> {
        @Override
        public @Nullable Particle createParticle(BoreDebrisParticleOptions options, ClientLevel level, double x, double y, double z,
